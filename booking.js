...
function book() {
    ...
    if (appointments.length != null) {
        for(i = 0; i < appointments.length; i++) {
            if(appointments[i].doc == selectedDoctor && appointments[i].time == selectedTime && appointments[i].apptDate == selectedDate&&appointments[i].pat==selectedName) {
    ...
    //console.log(appointments); check appointments array
}
