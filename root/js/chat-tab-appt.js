...
var chatID = JSON.parse(window.localStorage.getItem("chatID"));  
//var chats = JSON.parse(window.localStorage.getItem("chats"));
//if(window.localStorage.getItem("apptChat") === null) {
//    var chat = [];
//}
//else {
//    var chat = JSON.parse(window.localStorage.getItem("apptChat"));
//}

var currChat = appointments[chatID].chat;                                             
...
function backBtn() {
    ...
    appointments[chatID].chat = currChat;
